...
<body>
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="<?php echo Url::to(['goods/detail','id'=>$new['id']])?>"><img src="<?php echo $new['logo'];?>" alt="" /></a></dt>
								<dd><a href="<?php echo Url::to(['goods/detail','id'=>$new['id']])?>"><?php echo $new['name'];?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo $new['shop_price'];?></strong></dd>
							</dl>
						</li>
						<?php endforeach;?>
					</ul>
				...
				<div class="recommend none">
					<ul>
						<?php foreach($bestList as $best):?>
							<li>
								<dl>
									<dt><a href="<?php echo Url::to(['goods/detail','id'=>$best['id']])?>"><img src="<?php echo $best['logo'];?>" alt="" /></a></dt>
									<dd><a href="<?php echo Url::to(['goods/detail','id'=>$best['id']])?>"><?php echo $best['name'];?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo $best['shop_price'];?></strong></dd>
								</dl>
							</li>
						<?php endforeach;?>
					</ul>
	...
	<!-- 底部导航 start -->
	<div class="bottomnav w1210 bc mt10">111
