	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo $goodsDetail->name;?></strong></h3>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo $goodsDetail->sn;?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo $goodsDetail->market_price;?></em></li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span><?php echo $goodsDetail->name;?></li>
								<li><span>商品编号：</span><?php echo $goodsDetail->sn;?></li>
								<li><span>品牌：</span><?php echo $goodsDetail->brand;?></li>
								<li><span>上架时间：</span><?php echo date('Y-m-d H:i:s',$goodsDetail->inputtime);?></li>
							</ul>
						</div>
